...
describe("mention-resolution-worker", () => {
  ...
  // Found via manual testing (2026-09-08, ported from the sibling
  // AuthNexus fork): a real person composing an @mention naturally has a
  // username on hand, never an opaque userId -- resolveIdentifier now
  // matches loginName too, not just userId/email.
