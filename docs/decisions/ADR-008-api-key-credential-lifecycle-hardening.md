...
- **Legacy SHA-256-only keys (#291) now have a forcing function** — a 30-day rotation deadline,
  tighter than the general 90-day grace period since they compound weak hashing with immortality.
  Both windows are signed off (OQ-2/OQ-3, 2026-08-24).
...
| OQ-2 | **Resolved (2026-08-24, signed off by abmish): 90-day grace period**, notified in advance, before existing keys are forced onto the new `expires_at` default lifetime.                                                                                                                                                                                                                                                                                                                               | Sign-off closes issue #430. Stage 1's forced-migration work for already-existing keys can now proceed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| OQ-3 | **Resolved (2026-08-24, signed off by abmish): 30-day forced-rotation deadline** for legacy SHA-256-only keys (#291), tighter than OQ-2's general grace period since they compound weak hashing _and_ immortality.                                                                                                                                                                                                                                                                                   | Sign-off closes issue #430.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
