 ...
 *
 * Ported from the sibling AuthNexus fork (2026-09-08): a same-day
 * synchronous 422-on-unresolved-mention design was tried and reverted once
 * security review flagged it as a fast, scriptable "does this identifier
 * exist" oracle. This test restores the original async-only contract this
 * route always had before that detour.
 *
...
const TENANT = "eeeeeeee-0000-4000-e000-000000000806";
const API_KEY_ID = "55555555-5555-5555-5555-555555555557";
...
function makeApp() {
  ...
  app.use("*", async (c: Context<Vars>, next: Next) => {
    c.set("auth", {
      userId: "apikey:55555555-5555-5555-5555-555555555557",
      tenantId: TENANT,
      roles: ["entity:ticket:comment"],
      email: "",
      displayName: "API Key 55555555557",
      orgId: "org-eee",
    });
    c.set("actingPerson", {
      userId: CREATOR,
