...
# gen-pat.mjs is mounted read-only from the OpenWind scripts/ folder.
# The output/ folder is mounted so gen-pat.mjs can write pat.txt to the host.
$composeYml = @"
name: zitadel

# ── Auto-generated by OpenWind setup script — do not edit manually ───────────
# Source: $owDir\scripts\gen-pat.mjs
# Recreate by deleting this folder and re-running setup.bat in the OpenWind repo.
...
services:
  ...
  ow-zita-setup:
    ...
    working_dir: /app
    volumes:
      - ${genPatSrc}:/app/scripts/gen-pat.mjs:ro
