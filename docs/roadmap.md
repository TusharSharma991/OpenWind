...
| Parallel approval pattern — approval sub-entities, automation monitors quorum | **Important — Config** | The *pattern* is config: approval entity type + automation rule that checks quorum and fires parent transition. No special engine code |
